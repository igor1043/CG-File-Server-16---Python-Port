...
class SettingsSectionFrame(tk.Frame):
    ...
    def save_entry(self) -> None:
        if not self.app._has_selected_fifa_exe():
            messagebox.showwarning(self.tr("message.settings"), self.tr("message.settings.select_fifa_before_save"))
            return
    ...
    def delete_entry(self) -> None:
        if not self.app._has_selected_fifa_exe():
            messagebox.showwarning(self.tr("message.settings"), self.tr("message.settings.select_fifa_before_edit"))
            return
...
def stadium_specs() -> list[SectionSpec]:
    return [
        SectionSpec("stadium", "dialog.editor.choice.team_stadiums", kind="stadium", directory="StadiumGBD"),
        SectionSpec("comp", "dialog.editor.choice.competition_stadiums", kind="stadium", directory="StadiumGBD"),
        SectionSpec("stadiumnetname", "dialog.editor.choice.net_by_stadium_name", kind="net", directory="StadiumGBD"),
        SectionSpec("stadiumnetid", "dialog.editor.choice.net_by_stadium_id", kind="net"),
        SectionSpec("scoreboardstdname", "dialog.editor.choice.scoreboard_stadium_name", kind="scoreboardstdname", directory="StadiumGBD"),
        SectionSpec("exclude", "dialog.editor.choice.excluded_competitions", kind="exclude"),
    ]
